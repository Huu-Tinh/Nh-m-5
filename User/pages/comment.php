                ...
                <div class="card-body">
                    ...
                    <div class="mb-4 pb-6 d-flex flex-start align-items-center">
                        <!-- <div class="rounded-circle shadow-1-strong me-3 alert-dark" style="width: 60px; height: 60px;">
                            <img class="rounded-circle shadow-1-strong me-3" src="../Admin/assets/images/profile/user-1.jpg" alt="avatar" width="60" height="60" />
                        </div> -->
                        <div>
                    ...
                    <div class="mt-3 mb-4 pb-2">
                        <div class="row">
                            ...
                            <div class="col-lg-9 text-primary">
                                ...
                                <p class=" ">
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iusto cum voluptatibus minima alias ipsa placeat eos facilis, consequatur quibusdam dolor eius blanditiis, adipisci magni eveniet iure neque necessitatibus exercitationem enim.
                                </p>
                                <p class="text-black-50">12-12-2023</p>
                                <div class="float-end">
